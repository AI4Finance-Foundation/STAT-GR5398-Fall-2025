...
def main():
    ...
    #     "./data_processor/sp500_tickers_daily_price_20250812.csv",
    #     usecols=usecols,
    #     dtype=dtypes,
    ...
    #df_price = pd.read_csv("./data_processor/sp500_tickers_daily_price_20250812.csv")
    ...
    with open('./portfolio_result/all_return_table.pickle', 'rb') as handle:
        all_return_table = pickle.load(handle)

    with open('./portfolio_result/all_stocks_info.pickle', 'rb') as handle:
    ...
    df_rl.to_csv("./drl_results/drl_weight.csv")
